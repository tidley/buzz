...
Local release APKs use the Android debug signing key so they can be installed
for testing without upload-key credentials. A separately managed distribution
pipeline must re-sign artifacts before publishing to Zapstore.
